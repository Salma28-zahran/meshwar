...
class AppColors {
  ...
  /// Main app gradient.
  /// Use this instead of repeating gradient colors inside widgets.
  ...
  static Color get textGrey =>
      isDark
          ? const Color(0x80B7B6B6)
          : const Color(0xFF6C6C6C);

  static Color get textGreyAndWhite =>
      isDark
          ? const Color(0xFFFFFFFF)
          : const Color(0xFF6C6C6C);

  static Color get inputTextColor =>
      isDark
          ? const Color(0xFFFFFFFF)
          : const Color(0xFF6C6C6C);
  ...
  static Color get inputBorderGrey =>
      isDark
          ? primaryColor
          : const Color(0xFFB7B6B6);

  static Color get dividerAuthColor =>
      isDark
  ...
  static Color get lightBorder =>
      isDark
          ...
          : const Color(0x33B7B6B6);

  static Color get cardBorder50 =>
      isDark
          ? primaryColor.withValues(alpha: 0.50)
          : const Color(0x80B7B6B6);

  static Color get chatGrey =>
      isDark
          ? primaryColor.withValues(alpha: 0.30)
          : const Color(0xFFE8E8EA);

  static Color get paymentDashedLine =>
      isDark
          ? primaryColor.withValues(alpha: 0.35)
          : const Color(0xFFE2E2E5);

  static Color get paymentPlanHeaderBorder =>
      isDark
          ? primaryColor.withValues(alpha: 0.20)
          : const Color(0xFFEEEEF0);

  static Color get readingProgressTrack =>
      isDark
          ? primaryColor.withValues(alpha: 0.25)
          : const Color(0xFFE4E2DD);

  static Color get borderInputColor =>
      isDark
          ? primaryColor.withValues(alpha: 0.25)
          : Colors.grey.shade200;

  static Color get whiteOrange =>
      isDark
          ? const Color(0xFF1A1A1A)
  ...
  static const paymentMethodSelectedBorder =
  Color(0xB3A0181A);
